...
<html lang="da">
    <head>
        <title>Draupnir Danmark | Næserem ORKA</title>
        <?php include("../partials/head.php"); ?>
        <meta name="title" content="Draupnir Danmark | næserem ORKA | kvalitet til islandske heste"/>
        <meta name="description" content="Hannoveransk næserem fra ORKA i økovenlig kvalitetslæder - hovedtøj med spænder i rustfrit stål - holdbar trense -  rideudstyr til islænder"/>
        <meta name="subject" content="Hannoveransk næserem fra ORKA i økovenlig kvalitetslæder - hovedtøj med spænder i rustfrit stål - holdbar trense -  rideudstyr til islænder"/>
    </head>
        ...
        <main>
            ...
            <div class="product_grid_products">
                ...
                <div class="grid_container_diasshow">
                    <img class="slide_img" alt="draupnir hannoveransk næserem ORKA til islandsk hest" src="../img/products/hannoveransk_næsere_-orka_2.png"/>
                </div>
                <div class="grid_container_product_text">
                    ...
                    <h2 class="product_heading"><b>Hannoveransk næserem ORKA</b></h2>
                    <p>Hannoveransk næserem fra Draupnir i samme lækre og holdbare læderkvalitet som de øvrige Draupnir-produkter. Læderet er italiensk og tysk og er garvet under miljøvenlige forhold. En smuk lak-detalje er tilføjet på næsestykket. Nakkestykket er i sort læder med spænder, der er udformet så de ikke er til gene for hesten.
