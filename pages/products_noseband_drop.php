...
<html lang="da">
    <head>
        <title>Draupnir Danmark | Hannoveransk næserem</title>
        <?php include("../partials/head.php"); ?>
        <meta name="title" content="Draupnir Danmark | hannoveransk næserem | kvalitet til islandske heste"/>
        <meta name="description" content="Hannoveransk næserem i stærk, tysk og italiensk økovenlig kvalitetslæder - hovedtøj med spænder, der ikke er til gene - holdbar trense - rideudstyr til islænder"/>
        <meta name="subject" content="Hannoveransk næserem i stærk, tysk og italiensk økovenlig kvalitetslæder - hovedtøj med spænder, der ikke er til gene - holdbar trense - rideudstyr til islænder"/>
    </head>
        ...
        <main>
            ...
            <div class="product_grid_products">
                ...
                <div class="grid_container_diasshow">
                    <img class="slide_img" alt="draupnir hannoveransk næserem til islandsk hest" src="../img/products/hannoveransk_næserem_8.png"/>
                </div>
                <div class="grid_container_product_text">
                    ...
                    <h2 class="product_heading"><b>Hannoveransk næserem</b></h2>
                    <p>Hannoveransk næserem fra Draupnir i samme lækre og holdbare læderkvalitet som de øvrige Draupnir-produkter. Læderet er italiensk og tysk og er garvet under miljøvenlige forhold. 
                ...
                <div class="wrapper">
                    ...
                    <div class="container">
                        ...
                        <div class="filterDiv noseband">
                            <img
                                class="products_filter_img" alt="draupnir hannoveransk næserem swarovski til islandsk hest" src="../img/products/hannoveransk_næserem_swarovski_5.1.png"/>
