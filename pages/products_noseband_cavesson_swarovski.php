...
<html lang="da">
    <head>
        ...
        <meta name="description" content="Engelsk næserem med swarovski sten i økovenlig kvalitetslæder - hovedtøj med spænder i rustfrit stål - holdbar komfortabel trense - rideudstyr til islænder"/>
        <meta name="subject" content="Engelsk næserem med swarovski sten i økovenlig kvalitetslæder - hovedtøj med spænder i rustfrit stål - holdbar komfortabel trense - rideudstyr til islænder"/>
    </head>
            ...
            <div class="product_grid_products">
                ...
                <div class="grid_container_diasshow">
                    <div class="slideshow-container">
                        <div class="mySlides fade">
                            <img class="slide_img" alt="draupnir engelsk næserem swarovski til islandsk hest" src="../img/products/engelsk_naeserem_swarovski_3.1.png"/>
                        </div>
                        <div class="mySlides fade">
                            <img class="slide_img" alt="draupnir engelsk næserem swarovski til islandsk hest" src="../img/products/engelsk_naeserem_swarovski_3.2.png"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid_container_dots">
                    <div style="text-align: center">
                        <span class="dot dot15" onclick="currentSlide(1)"></span>
                        <span class="dot dot16" onclick="currentSlide(2)"></span>
                    </div>
                </div>
                ...
                <div class="grid_container_product_text">
                    ...
                    <h2 class="product_heading"><b>Engelsk næserem SWAROVSKI</b></h2>
                    <p>Wngelsk næserem fra Draupnir med enten én eller to rækker swarovskisten. Næseremmen er i samme lækre og holdbare læderkvalitet som de øvrige Draupnir-produkter. Læderet er italiensk og tysk og er garvet under miljøvenlige forhold. 
