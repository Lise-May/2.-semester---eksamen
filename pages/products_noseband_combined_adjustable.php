...
<html lang="da">
    <head>
        <title>Draupnir Danmark | Kombineret/engelsk næserem justerbar</title>
        <?php include("../partials/head.php"); ?>
        <meta name="title" content="Draupnir Danmark | kombineret-engelsk næserem justerbar | kvalitet til islandske heste"/>
        <meta name="description" content="Kombineret-engelsk næserem justerbar i økovenlig kvalitetslæder - foret hovedtøj med spænder i rustfrit stål - holdbar trense - rideudstyr til islænder"/>
        <meta name="subject" content="Kombineret-engelsk næserem justerbar i økovenlig kvalitetslæder - foret hovedtøj med spænder i rustfrit stål - holdbar trense - rideudstyr til islænder"/>
    </head>
        ...
        <main>
            ...
            <div class="product_grid_products">
                ...
                <div class="grid_container_diasshow">
                    <img class="slide_img" alt="draupnir kombineret/engelsk næserem justerbar til islandsk hest" src="../img/products/kombineret_engelsk_næserem_justerbar_12.png"/>
                </div>
