...
<html lang="da">
    <head>
        <title>Draupnir Danmark | Hannoveransk næserem justerbar</title>
        <?php include("../partials/head.php"); ?>
        <meta name="title" content="Draupnir Danmark | hannoveransk næserem justerbar | kvalitet til islandske heste"/>
        <meta name="description" content="Hannoveransk næserem justerbar i økovenlig kvalitetslæder - foret hovedtøj med spænder i rustfrit stål - holdbar trense - rideudstyr til islænder"/>
        <meta name="subject" content="Hannoveransk næserem justerbar i økovenlig kvalitetslæder - foret hovedtøj med spænder i rustfrit stål - holdbar trense - rideudstyr til islænder"/>
    </head>
        ...
        <main>
            ...
            <div class="product_grid_products">
                ...
                <div class="grid_container_diasshow">
                    <img class="slide_img" alt="draupnir hannoveransk næserem justerbar til islandsk hest" src="../img/products/hannoveransk_næserem_justerbar_11.png"/>
                </div>
                <div class="grid_container_product_text">
                    ...
                    <h2 class="product_heading"><b>Hannoveransk næserem justerbar</b></h2>
                    <p>Hannoveransk næserem fra Draupnir i samme lækre og holdbare læderkvalitet som de øvrige Draupnir-produkter. Læderet er italiensk og tysk og er garvet under miljøvenlige forhold. Næsestrykket kan justeres i længde, så bliver tilpasset hesten fuldstændigt. Flere næsestykker i forskellige designs kan købes separat.
                ...
                <div class="wrapper">
                    ...
                    <div class="container">
                        <div class="filterDiv noseband">
                            ...
                            <h4>Næsestykke til <br />justerbar næserem</h4>
                        ...
                        <div class="filterDiv noseband">
                            ...
                            <a href="../pages/products_noseband._combined_adjustable.php">
                                <h5 class="products_filter_btn">LÆS MERE</h5>
                            </a>
                        </div>
