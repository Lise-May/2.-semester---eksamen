<div class="flex_box">
    <!-- address -->
    <div class="address">
        <h2 class="footer_h2 white_text">Draupnir Danmark</h2>
        <p class="white_text">
            Debelmosevej 3<br />
            6900 Skjern<br /><br />
            CVR: 32165400
    ...
    <section class="icon_section">
            ...
            <div class="icon_background">
                <a href="mailto:kontakt@draupnir.com" class="icon_anchor">
                    <svg class="icon" height="480pt" viewBox="0 0 480 480" width="480pt" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="m352 144h-224c-4.417969 0-8 3.582031-8 8v176c0 4.417969 3.582031 8 8 8h224c4.417969 0 8-3.582031 8-8v-176c0-4.417969-3.582031-8-8-8zm-21.601562 16-90.398438 77.464844-90.398438-77.464844zm-194.398438 160v-150.609375l98.792969 84.679687c2.992187 2.5625 7.40625 2.5625 10.398437 0l98.808594-84.679687v150.609375zm0 0"/>
                    </svg>
                </a>
            </div>
            <div class="icon_background">
                <a href="https://goo.gl/maps/QionMWBkwZSLFn4k6" target="_blank" class="icon_anchor">
                    <svg class="icon" height="480pt" viewBox="0 0 480 480" width="480pt" xmlns="http://www.w3.org/2000/svg">
                        <path d="m240 0c-132.546875 0-240 107.453125-240 240s107.453125 240 240 240 240-107.453125 240-240c-.148438-132.484375-107.515625-239.851562-240-240zm0 464c-123.710938 0-224-100.289062-224-224s100.289062-224 224-224 224 100.289062 224 224c-.140625 123.652344-100.347656 223.859375-224 224zm0 0"/>
                        <path d="m240 112c-52.996094.058594-95.941406 43.003906-96 96 0 66.542969 86.65625 153.96875 90.34375 157.65625 3.125 3.121094 8.1875 3.121094 11.3125 0 3.6875-3.6875 90.34375-91.113281 90.34375-157.65625-.058594-52.996094-43.003906-95.941406-96-96zm0 236.425781c-19.113281-20.425781-80-89.59375-80-140.425781 0-44.183594 35.816406-80 80-80s80 35.816406 80 80c0 50.785156-60.894531 120-80 140.425781zm0 0"/>
                        <path d="m240 160c-17.671875 0-32 14.328125-32 32s14.328125 32 32 32 32-14.328125 32-32-14.328125-32-32-32zm0 48c-8.835938 0-16-7.164062-16-16s7.164062-16 16-16 16 7.164062 16 16-7.164062 16-16 16zm0 0"/>
                    </svg>
                </a>
            </div>
            <div class="icon_background">
                <a href="tel:+45-5194-9561" class="icon_anchor">
                    <svg class="icon" height="480pt" viewBox="0 0 480 480" width="480pt" xmlns="http://www.w3.org/2000/svg">
                        <path d="m240 0c-132.546875 0-240 107.453125-240 240s107.453125 240 240 240 240-107.453125 240-240c-.148438-132.484375-107.515625-239.851562-240-240zm0 464c-123.710938 0-224-100.289062-224-224s100.289062-224 224-224 224 100.289062 224 224c-.140625 123.652344-100.347656 223.859375-224 224zm0 0"/>
        ...
        <section class="trustpilot">
            <h2 class="trustpilot_section_h2">Trustpilot Section</h2>
            <!-- TrustBox widget - Micro Review Count -->
            <div class="trustpilot-widget" data-locale="da-DK" data-template-id="5419b6a8b0d04a076446a9ad" data-businessunit-id="608fb4cb377e490001769c69" data-style-height="24px" data-style-width="100%" data-theme="dark">
                 <a href="https://dk.trustpilot.com/review/draupnir.com" target="_blank" rel="noopener">Trustpilot</a>
            </div>
            <!-- End TrustBox widget -->
        </section>
            <a href="../privacypolicy.php" class="privacy_link white_text">Privatlivspolitik</a>
    </section>
</div>
<!-- copyright bottom -->
<p class="white_text copyright"> &copy; Copyright 2021 Maja Wennerwald, Camilla Nørgaard, Lise-May Byfuglien, Melina Kaetow & Jesper Krüger. All rights reserved.</p>            